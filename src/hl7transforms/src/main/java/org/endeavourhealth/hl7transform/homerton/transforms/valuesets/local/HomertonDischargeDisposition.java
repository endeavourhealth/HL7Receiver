...
public enum HomertonDischargeDisposition {
    ...
    LEFT_DEPT_BEFORE_TREATMENT("left-dept-before_treatment", "Left department before treatment"),
    OTHER("other", "Other"),
    ...
    public String getSystem() { return "http://endeavourhealth.org/fhir/ValueSet/encounter-discharge-disposition-homerton"; }
